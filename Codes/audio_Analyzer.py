...
class AudioAnalyzer:
    ...
    def plot_spectrum(self, min_freq=0, max_freq=None, fill=False, title="Spectrogram - Average Frequency",fileName="None",c='b'):
        ...
        window.plot(x='bins', y='scaled_amplitude',color=c,figsize=(16,4))
        if fill:            
